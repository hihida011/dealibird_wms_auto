...
if test_google_log == 9:
    ...
    wms_side_columns_select_sendkeys(driver, "div>input[aria-label='필터 컬럼 입력']")
    ...
    try:
        while wms_search_list_row_index_ini >= wms_search_list_row : # 리스트 row 수 만큼 실행
            ...
            try:
                ...
                wms_search_list_row_result_check_3 = wms_search_list_row_id_result.find_element(By.CSS_SELECTOR, 'div[col-id="pieceStock"]') # 합계(낱개수량)
            ...
            try:
                ...
                wms_search_list_row_result_check_5 = wms_search_list_row_id_result.find_element(By.CSS_SELECTOR, 'div[col-id="statusName"]') # 입고상태
    ...
    #wms_side_columns_select(driver, "div>input[aria-label='필터 컬럼 입력']")
    #driver.find_element(By.CSS_SELECTOR, "div>input[aria-label='필터 컬럼 입력']").send_keys(Keys.CONTROL + "a") # 컬럼 검색 필드 - 입력값 전체 선택
    #time.sleep(2)
    #driver.find_element(By.CSS_SELECTOR, "div>input[aria-label='필터 컬럼 입력']").send_keys(Keys.DELETE) # 컬럼 검색 필드 - 입력값 삭제
    #time.sleep(5)
    ...
    # hihida 230314        
    deal_search_sendkeys(driver, "search_text")
    ...
    if test_os == "Windows":
        ...
        deal_out_excel_upload_file_path = os.path.join(mac_test_folder_path, deal_out_excel_upload_name_new)
