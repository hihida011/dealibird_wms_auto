...
buyer_wsIdx_name = '' # 사입 요청한 도매 wsIdx 값
...
time.sleep(2)
# google_sheet.update_acell('I17', 'OK') print(" PASS")
print(" 17 PASS")
print(" PASS")
...
print("##########")
print("결제 완료")
# google_sheet.update_acell('I18', 'OK') print(" PASS")
print("18 PASS")
...
print("사입 마감 처리 완료")
# hihida 221230
# google_sheet.update_acell('I19', 'OK') print(" PASS")
print("19 PASS")
time.sleep(10)
...
# google_sheet.update_acell('I16', 'OK') print(" PASS")
print("16 PASS")
...
# google_sheet.update_acell('I90', 'OK') print(" PASS")

# google_sheet.update_acell('I96', 'OK') print(" PASS")
# hihida 230102"""
...
print("105 PASS")
# google_sheet.update_acell('I108', 'OK') print(" PASS")
# google_sheet.update_acell('I111', 'OK') print(" PASS")
...
# 엑셀 파일 경로, 엑셀 파일 이름, 딜리버드 상품번호(1,2,3) 저장
file_info = {"path": deal_out_excel_upload_file_path, 
             "name": deal_out_excel_upload_name_new, 
             "deal_product_id_1" : deal_product_id_1, 
             "deal_product_id_2" : deal_product_id_2,
             "deal_product_id_3" : deal_product_id_3,
             "deal_seller_name"  : deal_seller_name,
             "deal_sell_product_name_1" : deal_sell_product_name_1,
             "deal_sell_product_name_2" : deal_sell_product_name_2,
             "deal_sell_product_name_3" : deal_sell_product_name_3,
             }
print("파일 저장 완료")
print("1. 정상입고 종료")
driver.quit()
